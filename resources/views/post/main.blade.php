...
<body>
  ...
  <div id="nav-content">
    ...
    <div class="wrapper">
      ...
      <nav>
        <ul>
          <li><a data-text="Home" href="{{route('index')}}">posts</a></li>
  ...
  <section id="hero">
    <div class="container">
      ...
      <div class="right">
        <img src="{{ asset('./image/profile.jpg') }}"  alt="ali_pourfereydoon">
      </div>
    </div>
  </section>
  ...
  <section id="testimonial">
    <div class="container">
      ...
      <div class="all-items">
        <div class="item">
          <div class="img">
            <img src="{{ asset('./image/sayed.jpg') }} alt="">
          </div>
        ...
        <div class="item">
          <div class="img">
            <img src="{{asset('./image/arfan.jpg')}} alt="">
          </div>
        ...
        <div class="item">
          <div class="img">
            <img src="{{asset('./image/ayan.jpg')}} alt="">
          </div>
    ...
    <div class="container">
      ...
      <div class="all-items">
        <div class="item">
          <div class="left">
            <div class="img">
              <img src="{{asset('./image/project-1.jpg')}} alt="">
            </div>
          </div>
          <div class="right">
        ...
        <div class="item">
          <div class="left">
            <div class="img">
              <img src="{{asset('./image/project-3.jpg')}} alt="">
            </div>
          </div>
          <div class="right">
        ...
        <div class="item">
          <div class="left">
            <div class="img">
              <img src="{{asset('./image/project-2.jpg')}}  alt="">
            </div>
          </div>
          <div class="right">
      ...
      <footer>
        <div class="col-1">
          <div class="logo"><a href="">
              <img src="{{asset('./image/light-logo.svg')}} alt="">
            </a></div>
